  ...
  try {
    ...
    if (is_reminder) {
       ...
       finalHtml = `<div style="background-color: #fffbeb; padding: 16px; border-left: 4px solid #f59e0b; margin-bottom: 24px; color: #92400e; font-family: sans-serif;">
            ...
            <p style="margin: 4px 0 0 0; font-size: 14px;">This is an automated reminder regarding ${document_number} via Invosmith.</p>
       </div>` + finalHtml;
    }
    ...
    const { data, error } = await resend.emails.send({
      from: "Invosmith <noreply@invosmith.in>",
      to: [to],
      subject: finalSubject || `${document_number} from Invosmith`,
      html: `
        <div style="font-family:'Segoe UI',system-ui,sans-serif;max-width:600px;margin:0 auto;">
          <div style="background:#0a0a0a;padding:24px;border-radius:12px 12px 0 0;">
            <h1 style="color:#f59e0b;font-size:20px;margin:0;">Invosmith</h1>
          </div>
          <div style="padding:24px;background:#ffffff;border:1px solid #eee;">
            ...
            <p style="color:#888;font-size:12px;margin-top:24px;">
              Generated by <a href="https://invosmith.vercel.app" style="color:#f59e0b;">Invosmith</a> — AI Invoice & Proposal Generator
            </p>
          </div>
        </div>
      `,
