...
<div class="page-wrap">
  ...
  ${settings?.plan !== "pro" && settings?.plan !== "agency" ? `
  <div style="margin-top:64px;text-align:center;font-size:11px;opacity:0.5;letter-spacing:1px;padding-top:20px;border-top:1px dashed #e2e8f0;">
    ⚡ Powered by <strong style="color: #f59e0b">Invosmith</strong>
    <br/>
    <span style="font-size:10px; opacity:0.8;">Generated with Invosmith.com &mdash; free for Indian freelancers.</span>
  </div>` : ""}
</div>
</body></html>`;
}
